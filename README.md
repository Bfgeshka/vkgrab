...
2. Choose any repository mirror and continue to chgoosing packages. Be sure you've chosen **libcurl** (bin- and dev-), **wget** and **gcc-core**. Let cygwin installer download it's dependencies aswell.
